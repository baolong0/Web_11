...
{
    public class TinTucCtrl : Controller
    {
        private readonly FootballNewsContext _context;

        public TinTucCtrl(FootballNewsContext context)
        {
            _context = context;
        }
        ...
        // GET: TinTucCtrl/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TinTucCtrl/Create
